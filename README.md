...
> Ruszczak, B., Kotowski, K., Evans, D., Nalepa, J. et al. (2025). *The OPS-SAT benchmark for detecting anomalies in satellite telemetry*. Scientific Data. Dataset: Zenodo, DOI: [10.5281/zenodo.12588359](https://doi.org/10.5281/zenodo.12588359).
<!-- TODO: re-pin to the exact record version fetched by scripts/fetch_data.py at data load -->
